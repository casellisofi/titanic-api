...
Este archivo contiene pruebas automatizadas para validar el correcto funcionamiento
de la API de predicción de supervivencia en el Titanic.
Utiliza TestClient de FastAPI y pytest.
"""

import pytest
from fastapi.testclient import TestClient
from app.main import app  # Importar correctamente la app desde app.main
...
def test_predict_out_of_range():
    ...
    payload = {
        ...
        "parch": 0,
        "fare": 7.25,
        "embarked": 99  # Valor fuera de rango
    }
    response = client.post("/predict/", json=payload)
    assert response.status_code == 422
